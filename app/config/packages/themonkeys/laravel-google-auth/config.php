...
return array(
    ...
    |
    */
    'clientId' => "505179446788-oh7k2kjmmd4u0i5t6i3t7dok7qkt4sk5.apps.googleusercontent.com",
    ...
    |--------------------------------------------------------------------------
    */
    'clientSecret' => "XPko_UHQUFqnbGIMHA2W8c27",
    ...
    |
    */
    'redirectUri' => URL::to('/me') . '/', // URL:to('/') doesn't include the trailing slash
    ...
    */
    ...
    |
    */
    'applicationName' => "enduring-branch-596",
